...
vim.g.nvim_ghost_python_executable = "/Users/sherwyn/.local/share/nvim/site/pack/paqs/start/nvim-ghost.nvim/.venv/bin/python"
...
vim.g.forestbones_lighten_comments = 80
